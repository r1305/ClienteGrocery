...
public class SubCategoryAdp extends RecyclerView.Adapter<SubCategoryAdp.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            title = (TextView) view.findViewById(R.id.txt_title_subcategory);
            thumbnail = view.findViewById(R.id.imageView_subcategory);
        }
    }
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Integer.parseInt(category.getCount()) == 0) {
                    Toast.makeText(mContext, "Lista de productos no encontrados", Toast.LENGTH_SHORT).show();
                } else {
